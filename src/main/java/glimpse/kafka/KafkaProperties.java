...
public interface KafkaProperties {
    ...
    static KafkaConfiguration loadConfiguration() throws IOException {
        ...
        return objectMapper.readValue(new File("/Users/kunal.singh1/projects/glimpse/src/main/java/glimpse/kafka/KafkaConfiguration.yml"), KafkaConfiguration.class);
    }
}
